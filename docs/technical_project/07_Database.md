...
1. Для решения цели в рамках выполнения требования **ФТ-08** предлагается использовать решение на базе технологии RAG. Для сложных задач семантического поиска принято использовать `BERT`-подобные модели модели эмбеддингов размерностью 768-1024.   
